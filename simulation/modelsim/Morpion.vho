...
SIGNAL \red_led~reg0_regout\ : std_logic;
...
-- Equation(s):
-- \Equal0~0\ = (!clk_count(2) & (!clk_count(1) & (clk_count[0] & !clk_count(3))))
...
-- Equation(s):
-- \Equal0~1\ = (!clk_count(5) & (!clk_count(7) & (!clk_count[4] & !clk_count(6))))
...
-- Equation(s):
-- \Equal0~2\ = (\Equal0~0\ & (((!clk_count[8] & \Equal0~1\))))
...
-- Equation(s):
-- clk_count(2) = DFFEAS(GND, GLOBAL(\clk~combout\), VCC, , , \Add1~10_combout\, , , VCC)
...
-- Equation(s):
-- row_count(1) = DFFEAS((row_count(1) $ (((\Equal0~2\ & !row_count(0))))), GLOBAL(\clk~combout\), VCC, , , , , , )
...
-- Equation(s):
-- row_count(2) = DFFEAS(row_count(2) $ (((!row_count(0) & (row_count(1) & \Equal0~2\)))), GLOBAL(\clk~combout\), VCC, , , , , , )
...
-- Equation(s):
-- row_count(0) = DFFEAS((row_count(0) & (((!\Equal0~2\)))) # (!row_count(0) & (\Equal0~2\ & ((!row_count(2)) # (!row_count(1))))), GLOBAL(\clk~combout\), VCC, , , , , , )
...
lastPlay : maxv_lcell
-- Equation(s):
-- \lastPlay~regout\ = DFFEAS(GND, GLOBAL(\clk~combout\), VCC, , , \play~combout\, , , VCC)
...
-- Equation(s):
-- \green_led~reg0_regout\ = DFFEAS((\green_led~reg0_regout\ $ (((!\play~combout\ & \lastPlay~regout\)))), GLOBAL(\clk~combout\), VCC, , , , , , )
...
lastHor : maxv_lcell
-- Equation(s):
-- \lastHor~regout\ = DFFEAS(GND, GLOBAL(\clk~combout\), VCC, , , \hor~combout\, , , VCC)
...
\red_led~reg0\ : maxv_lcell
-- Equation(s):
-- \red_led~reg0_regout\ = DFFEAS((\red_led~reg0_regout\ $ (((!\hor~combout\ & \lastHor~regout\)))), GLOBAL(\clk~combout\), VCC, , , , , , )
...
PORT MAP (
	...
	datad => \red_led~reg0_regout\,
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \red_led~reg0_regout\);
